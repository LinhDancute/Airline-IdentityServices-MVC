...
namespace Airline.WebClient.Migrations
{
    ...
    [Migration("20240612155956_Initial_ASPNET_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.Airline", b =>
                {
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.Airport", b =>
                {
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.BoardingPass", b =>
                {
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.BoardingPass_TicketClass", b =>
                {
                    b.Property<int>("BoardingPassID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.Flight", b =>
                {
                    b.Property<int>("FlightId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.FlightRoute", b =>
                {
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.FlightRoute_Airport", b =>
                {
                    b.Property<int>("FlightRouteID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.FlightRoute_Flight", b =>
                {
                    b.Property<int>("FlightRouteID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.Ticket", b =>
                {
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.TicketClass", b =>
                {
                    b.Property<int>("TicketId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Airline.WebClient.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Contacts.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Statistics.AnnualRevenue", b =>
                {
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Statistics.Invoice", b =>
                {
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Statistics.MonthlyRevenue", b =>
                {
                    b.Property<int>("MonthlyRevenueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Statistics.UnitPrice", b =>
                {
                    b.Property<int>("PriceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.Airline", b =>
                {
                    b.HasOne("Airline.WebClient.Models.Airlines.Airline", "ParentAirline")
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.BoardingPass", b =>
                {
                    b.HasOne("Airline.WebClient.Models.AppUser", null)
                        .WithMany("BoardingPasses")
                        .HasForeignKey("AppUserId");

                    b.HasOne("Airline.WebClient.Models.Airlines.Flight", "Flight")
                        .WithMany("BoardingPasses")
                        .HasForeignKey("FlightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Airline.WebClient.Models.AppUser", "Passenger")
                        .WithMany()
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.BoardingPass_TicketClass", b =>
                {
                    b.HasOne("Airline.WebClient.Models.Airlines.BoardingPass", "BoardingPass")
                        .WithMany()
                        .HasForeignKey("BoardingPassID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Airline.WebClient.Models.Airlines.TicketClass", "TicketClass")
                        .WithMany()
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.Flight", b =>
                {
                    b.HasOne("Airline.WebClient.Models.Airlines.Airline", "Airline")
                        .WithMany("Flights")
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.FlightRoute_Airport", b =>
                {
                    b.HasOne("Airline.WebClient.Models.Airlines.Airport", "Airport")
                        .WithMany("FlightRoute_Airports")
                        .HasForeignKey("AirportID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Airline.WebClient.Models.Airlines.FlightRoute", "FlightRoute")
                        .WithMany("FlightRoute_Airports")
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Airlines.Ticket", b =>
                {
                    ...
                    b.HasOne("Airline.WebClient.Models.Statistics.UnitPrice", "UnitPrice")
                        .WithMany()
                        .HasForeignKey("PriceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Airline.WebClient.Models.Statistics.UnitPrice", null)
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("Airline.WebClient.Models.Statistics.Invoice", b =>
                {
                    b.HasOne("Airline.WebClient.Models.Statistics.MonthlyRevenue", "MonthlyRevenue")
                        .WithMany("Invoices")
